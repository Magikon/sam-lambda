...
function startQueryExecution(){
  return new Promise((resolve, reject) => {
    ...
    var params = {
        QueryString: "SELECT * FROM recommendations WHERE dt >= '"+yesterdayPartition+"' AND dt <= '"+tomorrowPartition+"' AND created_at >= date_add('hour', -120, now());",
...
exports.handler = (event, context, callback) => {
  console.log("::::: Recommendation Reporting Service Starting")

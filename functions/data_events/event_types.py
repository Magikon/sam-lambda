...
event_types['email'] = { 
    ...
    'EmailTemplateId': { 'field_name': 'log_subtype_id', 'field_type': 'INT'},
    'EmailTemplateName': { 'field_name': 'log_subtype_name', 'field_type': 'VARCHAR'},
    'AgentId': { 'field_name': 'log_user_id', 'field_type': 'INT'},
    'AgentName': { 'field_name': 'log_user_name', 'field_type': 'VARCHAR'},
    'AgentEmail': { 'field_name': 'log_user_email', 'field_type': 'VARCHAR'},
    'GroupId': { 'field_name': 'group_id', 'field_type': 'INT'},
    'GroupName': { 'field_name': 'group_name', 'field_type': 'VARCHAR'}
}

event_types['export'] = { 
    'LogId': { 'field_name': 'log_id', 'field_type': 'INT'},
    'LogDate': { 'field_name': 'log_date', 'field_type': 'TIMESTAMP'},
    'Result': { 'field_name': 'log_subtype_name', 'field_type': 'VARCHAR'},
    'Message': { 'field_name': 'log_note', 'field_type': 'VARCHAR'},
    'AgentId': { 'field_name': 'log_user_id', 'field_type': 'INT'},
    'AgentName': { 'field_name': 'log_user_name', 'field_type': 'VARCHAR'},
    'AgentEmail': { 'field_name': 'log_user_name', 'field_type': 'VARCHAR'}
}

event_types['status'] = { 
    'LogId': { 'field_name': 'log_id', 'field_type': 'INT'},
    'LogDate': { 'field_name': 'log_date', 'field_type': 'TIMESTAMP'},
    'StatusId': { 'field_name': 'log_subtype_id', 'field_type': 'INT'},
    'StatusTitle': { 'field_name': 'log_subtype_name', 'field_type': 'VARCHAR'},
    'Result': { 'field_name': 'log_note', 'field_type': 'VARCHAR'},
    'AgentId': { 'field_name': 'log_user_id', 'field_type': 'INT'},
    'AgentName': { 'field_name': 'log_user_name', 'field_type': 'VARCHAR'},
    'AgentEmail': { 'field_name': 'log_user_email', 'field_type': 'VARCHAR'},
    'GroupId': { 'field_name': 'group_id', 'field_type': 'INT'},
...
event_types['distribution'] = { 
    'LogId': { 'field_name': 'log_id', 'field_type': 'INT'},
    'LogDate': { 'field_name': 'log_date', 'field_type': 'TIMESTAMP'},
    'DistributionProgramId': { 'field_name': 'log_subtype_id', 'field_type': 'INT'},
    'DistributionProgramName': { 'field_name': 'log_subtype_name', 'field_type': 'VARCHAR'},
    'Result': { 'field_name': 'log_note', 'field_type': 'VARCHAR'},
    'AssignedAgentId': { 'field_name': 'log_user_id', 'field_type': 'INT'},
    'AssignedAgentName': { 'field_name': 'log_user_name', 'field_type': 'VARCHAR'},
    'AssignedAgentEmail': { 'field_name': 'log_user_email', 'field_type': 'VARCHAR'},
...
event_types['action'] = { 
    ...
    'ActionTypeId': { 'field_name': 'log_subtype_id', 'field_type': 'INT'},
    'ActionTypeName': { 'field_name': 'log_subtype_name', 'field_type': 'VARCHAR'},
    'Message': { 'field_name': 'log_note', 'field_type': 'VARCHAR'},
    'AgentId': { 'field_name': 'log_user_id', 'field_type': 'INT'},
    'AgentName': { 'field_name': 'log_user_name', 'field_type': 'VARCHAR'},
    'AgentEmail': { 'field_name': 'log_user_email', 'field_type': 'VARCHAR'},
    'GroupId': { 'field_name': 'group_id', 'field_type': 'INT'},
    'GroupName': { 'field_name': 'group_name', 'field_type': 'VARCHAR'},
    'MilestoneId': { 'field_name': 'milestone_id', 'field_type': 'INT'}
}

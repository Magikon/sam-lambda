...
# payload = {'username':'djohnson@pro-pair.com', 'password': '5f3d9IrE23*pKf9x!oU4'}
velocify_get_report_url = 'https://service.leads360.com/ClientService.asmx/GetCallHistoryReport'

# DB_HOST = 'prcvb9rkw8qiqk.c6pocrcpqs8o.us-west-1.rds.amazonaws.com'
# DB_NAME = os.environ["DB_NAME"]
# DB_USER = os.environ["DB_USER"]
# DB_PASS = 'YWZssbwSU6EZ3ZPkZsnTuXuV2mnHBZJK'
...
def update(event, context):
    ...
    if (os.environ['ENV'] == 'staging' and account_id == 10):
        data = generate()
        ...
        while( len(records) < 1000 and end_date <= (datetime.today() + timedelta(hours=12)) ):
            ...
            secure_log("[{}] Fetching data from {} to {}").format(account, payload['startDate'], payload['endDate'])
